...
app.mouse.move.subscribe(event => {
  ...
  // const dx = app.mouse.world.x - sphere.position.x;
  // const dy = app.mouse.world.y - sphere.position.y;
  // const d = new Vector3(dx, dy, 0);
  // d.normalize();
  // d.multiplyScalar(0.1);
  // sphere.position.add(d);
  // sphere.lookAt(new Vector3(app.mouse.world.x, app.mouse.world.y, 0));
});
